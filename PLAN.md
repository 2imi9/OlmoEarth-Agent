...
**Skill catalog:** [`SKILLS.md`](SKILLS.md): 16 skills (Prep / Configure / Run / Analyze / Integrate / Report); skill #5 `olmoearth-change-detection` has an out-of-process JEPA engine (separate repo). The agent ships skills one PR at a time.
