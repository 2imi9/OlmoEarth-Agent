...
| C9 | Skill catalog | 19 skills in `SKILLS.md` (#1-#15 in v1.0; #16 `olmoearth-litsearch` + #17 `olmoearth-automate` added in v1.1.0; #18 `olmoearth-negative-sampler` added post-1.1; #19 `olmoearth-latent-change` out-of-process, backed by `2imi9/olmoearth-jepa-change`); 18 implemented in-repo, #19 out-of-process; vendored #1-#4 via submodule `vendor/olmoearth-skills` |
